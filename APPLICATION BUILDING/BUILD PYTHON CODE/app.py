...
API_KEY = "yytnMUqsOAds6UWf9ybh6kuDHFVWE5iic6WJ-o7qE5SM"
...
def predict():
    ...
    response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/a111103a-e6dc-4933-bc5a-5db8cc45c295/predictions?version=2022-11-17', json=payload_scoring,headers={'Authorization': 'Bearer ' + mltoken})
